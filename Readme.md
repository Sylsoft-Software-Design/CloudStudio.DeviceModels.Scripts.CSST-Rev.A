...
# Parsing Script – CSST - Rev. A

This **Parsing** script is designed for the **CSST** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – CSST Rev. A

Este script de **Parsing** está diseñado para el modelo **CSST** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
